...
using ZOGLAB.MMMS.Web.App.Startup;//SPA!
using ZOGLAB.MMMS.Web.Areas.Mpa.Startup;//MPA!
using ZOGLAB.MMMS.Web.Bundling;
using ZOGLAB.MMMS.Web.Navigation;
using ZOGLAB.MMMS.Web.Routing;
using ZOGLAB.MMMS.WebApi;
...
namespace ZOGLAB.MMMS.Web
{
    ...
    [DependsOn(
        ...
        typeof(MMMSDataModule),
        typeof(MMMSApplicationModule),
        typeof(MMMSWebApiModule),
    ...
    public class MMMSWebModule : AbpModule
    {
