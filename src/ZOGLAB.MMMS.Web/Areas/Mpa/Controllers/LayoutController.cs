...
using ZOGLAB.MMMS.Web.Areas.Mpa.Models.Layout;
using ZOGLAB.MMMS.Web.Areas.Mpa.Startup;
using ZOGLAB.MMMS.Web.Controllers;
using ZOGLAB.MMMS.Web.Models.Layout;
using ZOGLAB.MMMS.Web.Session;
using HeaderViewModel = ZOGLAB.MMMS.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace ZOGLAB.MMMS.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : MMMSControllerBase
    {
