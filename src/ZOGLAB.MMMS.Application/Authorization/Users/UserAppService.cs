...
using ZOGLAB.MMMS.Authorization.Permissions;
...
using ZOGLAB.MMMS.Authorization.Users.Exporting;
...
namespace ZOGLAB.MMMS.Authorization.Users
{
    ...
    public class UserAppService : MMMSAppServiceBase, IUserAppService
    {
