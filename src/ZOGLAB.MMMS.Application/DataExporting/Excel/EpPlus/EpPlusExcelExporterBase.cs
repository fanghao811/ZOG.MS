...
using ZOGLAB.MMMS.Net.MimeTypes;
using OfficeOpenXml;

namespace ZOGLAB.MMMS.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MMMSServiceBase, ITransientDependency
    {
